                                ...
                                {editingEventId === event.id ? (
                                    <>
                                        <div>
                                            ...
                                            <button className='btn btn-small margin-l-8' onClick={() => setEditingEventId(null)}>Cancel</button>
                                    ...
                                    <>
                                        ...
                                        <button className='btn btn-small btn-x margin-l-8' onClick={() => handleEventDelete(event.id)}>
                                            Delete
                                        </button>
                                    </>
                                )}
