        ...
        children: [
            ...
            { path: "contact", element: <Contact /> },
            {
                ...
                children: [
                    ...
                    { path: "checkout", element: <UserRoute><CheckoutForm /></UserRoute> },
                    { path: "check-session", element: <UserRoute><CheckSession /></UserRoute> },
                    { path: "return", element: <UserRoute><Return /></UserRoute> },
