...
const AdminBlogAdmin = ({ blogs, activeTabMode }) => {
    ...
    useEffect(() => {
        const filteredBlogs = blogs.filter(blog => blog.for_admin === true);
    ...
    return (
        <>
            <title>Gingham • Admin Blogs • Admins</title>
            {activeTabMode === 'add' && (
                <>
                    <h2 className='margin-b-16'>Add Admin Blog</h2>
