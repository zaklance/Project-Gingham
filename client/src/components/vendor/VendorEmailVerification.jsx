...
const VendorEmailVerification = () => {
    ...
    const handleConfirmation = async () => {
        ...
        try {
            const response = await fetch(
                `/api/vendor/confirm-email/${confirmationToken}`,
                {
                    method: "POST",
                    headers: {
    ...
    return (
        <div className="email-verification-container">
            <title>Gingham • Vendor Email Verification</title>
            {!isConfirmed ? (
                ...
                <div className="box-bounding text-center">
                    ...
                    <button className="btn btn-confirm" onClick={() => navigate("/vendor/logout")}>
                        Go Back
                    </button>
                </div>
            ) : (
