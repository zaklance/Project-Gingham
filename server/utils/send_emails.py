...
with app.app_context():
    ...
    send_email_vendor_market_new_event(email=email, user=user, market=market, event=event, link=f"/user/markets/{market.id}")
    send_email_vendor_market_schedule_change(email=email, user=user, market=market, event=event, link=f"/user/markets/{market.id}")
    ...
    send_email_vendor_new_review(email=email, user=user, vendor=vendor, review=review, link_review=f"/user/markets/{market.id}#reviews")
    ...
    send_email_admin_reported_review(email=email, user=user, vendor=vendor, market='', review=review, link_review=f"/user/markets/{market.id}#reviews")
