...
with app.app_context():
    ...
    send_email_user_vendor_review_response(email=email, user=user, vendor=vendor, review=review, link_review=f"/vendors/{vendor.id}#reviews")
    ...
    send_email_vendor_market_new_event(email=email, user=vendor_user, market=market, event=event, link=f"/markets/{market.id}")
    send_email_vendor_market_schedule_change(email=email, user=vendor_user, market=market, event=event, link=f"/markets/{market.id}")
    ...
    send_email_vendor_new_review(email=email, user=vendor_user, vendor=vendor, review=review, link_review=f"/markets/{market.id}#reviews")
    ...
    send_email_admin_reported_review(email=email, user=admin_user, vendor=vendor, market='', review=review, link_review=f"/markets/{market.id}#reviews")
