        ...
        body = f"""
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="footer">
                        <img class="img-logo-small" src="https://www.gingham.nyc/public/site-images/gingham-logo-A_3.png" alt="logo"/>
    ...
    try:
        ...
        body = f"""
            ...
            <body>
                <div class="email-container">
                    <div class="header">
                        <img class="img-logo" src="https://www.gingham.nyc/public/site-images/gingham-logo-A_3.png" alt="logo"/>
                    </div>
                    <hr class="divider"/>
